          ...
          <div className="flex gap-3 mx-auto">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all whitespace-nowrap ${activeFilter === cat.value ? 'bg-pink-500 text-white shadow-lg shadow-pink-500/30' : 'bg-white text-gray-400 hover:text-pink-500 shadow-sm'
                  }`}
              >
                {cat.label}
              </button>
